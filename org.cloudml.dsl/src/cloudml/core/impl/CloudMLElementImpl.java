 ...
 * <ul>
 *   <li>{@link cloudml.core.impl.CloudMLElementImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class CloudMLElementImpl extends MinimalEObjectImpl.Container implements CloudMLElement {
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.CLOUD_ML_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.CLOUD_ML_ELEMENT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.CLOUD_ML_ELEMENT__NAME:
				return getName();
		}
