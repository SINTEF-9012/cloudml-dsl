		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getProvidedPortCSAccess().getAlternatives_3_1_1_0(), "rule__ProvidedPortCS__Alternatives_3_1_1_0");
					put(grammarAccess.getInternalComponentCSAccess().getAlternatives_3(), "rule__InternalComponentCS__Alternatives_3");
					put(grammarAccess.getRequiredPortCSAccess().getAlternatives_3_1_1_0(), "rule__RequiredPortCS__Alternatives_3_1_1_0");
					...
					put(grammarAccess.getProvidedPortCSAccess().getGroup_3_1_1(), "rule__ProvidedPortCS__Group_3_1_1__0");
					put(grammarAccess.getProvidedPortCSAccess().getGroup_3_1_1_0_1(), "rule__ProvidedPortCS__Group_3_1_1_0_1__0");
					...
					put(grammarAccess.getRequiredPortCSAccess().getGroup_3_1_1(), "rule__RequiredPortCS__Group_3_1_1__0");
					put(grammarAccess.getRequiredPortCSAccess().getGroup_3_1_1_0_1(), "rule__RequiredPortCS__Group_3_1_1_0_1__0");
					...
					put(grammarAccess.getProvidedPortCSAccess().getIsLocalAssignment_3_1_1_0_0(), "rule__ProvidedPortCS__IsLocalAssignment_3_1_1_0_0");
					put(grammarAccess.getProvidedPortCSAccess().getPortNumberAssignment_3_1_1_0_1_2(), "rule__ProvidedPortCS__PortNumberAssignment_3_1_1_0_1_2");
					...
					put(grammarAccess.getRequiredPortCSAccess().getIsLocalAssignment_3_1_1_0_0(), "rule__RequiredPortCS__IsLocalAssignment_3_1_1_0_0");
					put(grammarAccess.getRequiredPortCSAccess().getPortNumberAssignment_3_1_1_0_1_2(), "rule__RequiredPortCS__PortNumberAssignment_3_1_1_0_1_2");
					put(grammarAccess.getRequiredPortCSAccess().getIsMandatoryAssignment_3_1_1_0_2(), "rule__RequiredPortCS__IsMandatoryAssignment_3_1_1_0_2");
					...
					put(grammarAccess.getRequiredExecutionPlatformCSAccess().getDemandsAssignment_3_1_3(), "rule__RequiredExecutionPlatformCS__DemandsAssignment_3_1_3");
					put(grammarAccess.getRequiredExecutionPlatformCSAccess().getPropertiesAssignment_3_2(), "rule__RequiredExecutionPlatformCS__PropertiesAssignment_3_2");
					...
					put(grammarAccess.getProvidedExecutionPlatformCSAccess().getOffersAssignment_3_1_3(), "rule__ProvidedExecutionPlatformCS__OffersAssignment_3_1_3");
					put(grammarAccess.getProvidedExecutionPlatformCSAccess().getPropertiesAssignment_3_2(), "rule__ProvidedExecutionPlatformCS__PropertiesAssignment_3_2");
